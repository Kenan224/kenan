...
# =============================================================================
# قسم 2: التحفيز المتجانس (تم تعديل أبعاد الرسومات هنا لتصبح أصغر)
# =============================================================================
HOMO_MODEL_INFO = {
...
def render_homogeneous():
    ...
    if homo_model == "Power-law (степенной закон)":
        ...
        try:
            ...
            # تعديل حجم الرسمة البيانية هنا تصغير الأبعاد من (6.5, 3.2) إلى (4.8, 2.4)
...
if __name__ == "__main__":
    main()    --secondary-background-color: #ffffff !important;
    --text-color: #1e293b !important;
    --primary-color: #2563eb !important;
    background-color: #f5f7fa !important;
    color: #1e293b !important;
